...
FireflyLED::FireflyLED(int pin, unsigned long interval_on, unsigned long interval_off, int number_of_flashes)
{
    ...
    this->interval_wait = 10000; //random(12000, 24000) - ((interval_on + interval_off) * number_of_flashes);
...
FireflyLED ff1(5, get_interval_on(), get_interval_off(), get_number_of_flashes());
